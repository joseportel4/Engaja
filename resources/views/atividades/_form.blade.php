...
<div class="mb-3">
  ...
  <div class="form-check mb-2">
    <input class="form-check-input" type="checkbox" id="municipios_toggle_all">
    <label class="form-check-label fw-semibold" for="municipios_toggle_all">Selecionar todos</label>
  </div>
  <div id="municipios"
